      ...
      <div >
        ...
        <Form :model="loginUser"  ref="loginUser" :rules="loginRule">
          ...
          <FormItem prop="password" label="密码">
            <Input size="large" @on-change="deleteEdit()" @keyup.enter.native="login" :on-enter="login" :type="pwdType" width="30%" v-model="loginUser.password"   placeholder="请输入密码" >
          ...
          <div>
            ...
            <Button @click="login" size="large" type="primary" :loading="loading">登&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;录</Button>
          </div>
      </div>
    </Card>
    <div>
